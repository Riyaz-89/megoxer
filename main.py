...
bot = telebot.TeleBot('7556718869:AAFWdEs83nfXI3NthR43nK3gD97_7KyvCFI')
...
ATTACK_TIME = 600 # set max attack time for users
...
def generate_key(duration, length=7):
    ...
    return f"VIP-{duration.upper()}-{key.upper()}"
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗱𝗱𝗼𝘀 𝗯𝗼𝘁!", reply_markup=markup)
